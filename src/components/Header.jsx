...
const Header = () => {
        ...
        <div>
            <div className='flex justify-between items-center py-1 px-32' style={{ backgroundImage: 'url(/bgupp.png)' }} >
                ...
                <div className='flex items-center gap-5 divide-x divide-white'>
                    <div className='font-semibold text-white text-sm'><i className="ri-phone-fill"></i> +91 9092345600</div>
            ...
            <div className='flex items-center shadow-md'>
                ...
                <div className=' flex items-center gap-28 pl-18 rounded-l-md' style={{ marginLeft: '1px' }}>
                    <div className='relative flex'>
                        <div className='py-3 px-30 text-white bg-[#0Fa4Af] rounded-l-md'>
    ...
    <div className='flex items-center gap-2'>
        ...
        <div className='leading-2 text-base cursor-pointer'>
            ...
            <div className='flex justify-between items-center px-3 shadow-md py-2 font-normal text-sm'>
